export default function Modal({
  ...
  return (
    ...
    >
      ...
      >
        <div className="py-2.5 px-6 border-0 border-b border-solid border-slate-200 flex justify-between items-center shrink-0">
        ...
        {footer && (
          <div className="py-2.5 px-6 border-0 border-t border-solid border-slate-100 flex justify-end items-center gap-2.5 shrink-0">
            {footer}
          </div>
        )}
      </div>
