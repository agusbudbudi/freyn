...
export default function ResultPage() {
  ...
  const openLink = (url, name) => {
    if (url) {
      ...
      toast.error(`${name} link not available for this project`);
    }
  };
  ...
  return (
    <div className="container">
      ...
      <div className="buttons-section">
        <button
          onClick={() => openLink(project.deliverables, "Deliverables")}
        ...
        <button
          onClick={() => openLink(project.invoice, "Invoice")}
          className="btn btn-secondary"
          style={{
            opacity: project.invoice ? "1" : "0.6",
          }}
        >
          Download Invoice
        </button>
      ...
      <div className="social-section">
        ...
        <div className="footer">
          <p>
            Generated by <strong>Freelance Management System</strong>
          </p>
        </div>
      </div>
